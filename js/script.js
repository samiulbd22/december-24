...
const members = {
    ...
    "01922362569":{
        ...
        payment             :{"30/11/24-Cash":400,"10/12/24-DBBL":2000,"20/12/24-Cash":500,"26/12/24-Cash":500,"30/12/24-Cash":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :3226,
        running_paid    :3900,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01744459622":{
        ...
        payment             :{"05/12/24-Cash":5000,"26/12/24-Cash":500},
        // running month
        stay_cost       :2700,
        garage_cost     :200,
    ...
    "01644377150":{
        ...
        payment             :{"05/12/24-Cash":4000,"14/12/24-Cash":1000,"28/12/24-bKash":1000},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
    ...
    "01645122114":{
        ...
        payment             :{"12/12/24-Cash":3000,"16/12/24-bKash":3000,"22/12/24-bKash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01714443406":{
        ...
        previous_paid       :6000,
        previous_dining_cost:2088,
        payment             :{"06/12/24-Cash":3000,"09/12/24-Cash":2000,"27/12/24-Cash":500,"30/12/24-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01834648400":{
        ...
        previous_paid       :4000,
        previous_dining_cost:1624,
        payment             :{"12/12/24-Bkash":2000,"22/12/24-Bkash":500},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
    ...
    "01749244430":{
        ...
        post_payable        :4635,
        previous_paid       :6500,
        previous_dining_cost:1856,
        payment             :{"10/12/24-Cash":5000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
